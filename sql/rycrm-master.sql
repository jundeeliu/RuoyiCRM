...
-- ----------------------------
BEGIN;
INSERT INTO `master_tenant` VALUES (1, 'tenant1', 'jdbc:mysql://localhost:3306/rycrm-tenant-1?useSSL=false', 'root', 'root');
INSERT INTO `master_tenant` VALUES (2, 'tenant2', 'jdbc:mysql://localhost:3306/rycrm-tenant-2?useSSL=false', 'root', 'root');
COMMIT;
