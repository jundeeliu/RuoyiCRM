  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="业务员" prop="owner">
        <el-select v-model="queryParams.owner" placeholder="请选择业务员" clearable>
          <el-option v-for="owner in ownerList" :key="owner.owner" :label="owner.nickName" :value="owner.userName"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item>
